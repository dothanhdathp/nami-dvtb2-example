...
app_function (void *userdata)
{
    ...
    /* Build pipeline */
    data->pipeline = gst_parse_launch ("ahcsrc ! video/x-raw,width=1280,height=720,framerate=30/1 ! glimagesink", &error);
...
JNI_OnLoad (JavaVM * vm, void *reserved)
{
    ...
    jclass klass = (*env)->FindClass (env, "nami/example/dtvbt2/MainActivity");
